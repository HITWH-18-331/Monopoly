...
class character:
    ...
    def check(self):
        ...
        if self.cheat[0] * self.cheat[1] * self.cheat[2] == 1:
            ...
            screen.blit(font.render("依次按下DWQ进入开发者模式，查看NPC的状态", True, [0, 0, 255]), (27 * 25, 7 * 25))
            return False
    ...
    def __displayIncidents(self, L, incidents):
        ...
        # 事件1: 到达马场
            ...
            # 买了马想升级
                ...
                messages.append(font.render("按B键花费金币2000将战马升级为千里马", True, [0, 0, 255]))
    ...
    def shopping(self, Ls):
        if self.playerControl is True:
            self.__buy(Ls.lands, Ls.cattleOfPC)
        else:
            self.__autoBuy(Ls.lands, Ls.cattleOfNPC)
